  ...
  (lambda (_ palette)
    (define (get-home-services config)
      ...
      (define color-overrides
        `((0 . ,(palette 'accent-0-text))
          (1 . ,(palette 'accent-1-text))
          (2 . ,(palette 'accent-2-text))
          (3 . ,(palette 'accent-3-text))
          (4 . ,(palette 'accent-4-text))
          (5 . ,(palette 'accent-5-text))
          (6 . ,(palette 'accent-6-text))
          (7 . ,(palette 'accent-7-text))
          (8 . ,(farg:brighten (palette 'accent-0-text) 10))
          (9 . ,(farg:brighten (palette 'accent-1-text) 10))
          (10 . ,(farg:brighten (palette 'accent-2-text) 10))
          (11 . ,(farg:brighten (palette 'accent-3-text) 10))
          (12 . ,(farg:brighten (palette 'accent-4-text) 10))
          (13 . ,(farg:brighten (palette 'accent-5-text) 10))
          (14 . ,(farg:brighten (palette 'accent-6-text) 10))
          (15 . ,(farg:brighten (palette 'accent-7-text) 10))))
        ...
        `((".config/swaylock/config"
           ,(alist->ini "swaylock-config"
                        `(("daemonize")
                          ...
                          ("indicator-radius" . 80)
                          ("key-hl-color" . ,(strip-hex (palette 'accent-0)))
                          ...
                          ("ring-clear-color" . ,(strip-hex (palette 'accent-0)))
